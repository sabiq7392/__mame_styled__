...
export default function Home() {
  ...
  return (
    <>
      <Grid cssXs={{ padding: spacing.lg }}>
        <Container as="article">
          <HtmlTag />
        </Container>

        <Container as="article">
          <H2 cssXs={{ color: 'white' }} size={{ lg: 32 }}>Installation</H2>
          <Description 
            text="
        ...
        <Container as="article">
          <H2 cssXs={{ color: 'white' }} size={{ lg: 32 }}>Why Mame Styled?</H2>
          <Description
            text="
        ...
        <Container as="article">
          <H2 cssXs={{ color: 'white' }} size={{ lg: 32 }}>Thanks to</H2>
