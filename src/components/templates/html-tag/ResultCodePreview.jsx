      ...
      {`
        ...
        >
          ...
          <Div cssXs={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 20, padding: 20 }}>
            <Blockquote cssXs={{ lineHeight: '175%', color: 'rgba(255, 255, 255, 0.8)' }} size={{ xs: 10, md: 12, lg: 14}}>
            ...
            <Figcaption cssXs={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
              <H1 cssXs={{ color: '#90E0EF', fontWeight: 500 }} size={{ xs: 14, md: 16, lg: 18 }}>Sabiq Muhammad</H1>
              <Small cssXs={{ color: 'rgba(255, 255, 255, 0.5)', fontWeight: 600, letterSpacing: 0.4 }} size={{ xs: 10, md: 12, lg: 14 }}>Fullstack Developer, Jakarta</Small>
            </Figcaption>
          </Div>
        </Figure>
      `}
