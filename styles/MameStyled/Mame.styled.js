...
import { Div, Section, Article, Header, Footer, Figure, Nav, Button } from './core/HtmlTag.styled';

export { Typography, Grid, Flex, Div, Section, Article, Header, Footer, Figure, Nav, Button };
